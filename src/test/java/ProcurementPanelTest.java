...
public class ProcurementPanelTest extends BaseStep {
    ...
    @Test
    @Order(2)
    @DisplayName("Satın Alma Sayfası Test Ediliyor")
    public void PageProcurementPanel() {
        BaseStep.waitSeconds(3);
        LogTest.info("Satın Alma dropdown aranıyor");
        WebElement ProcurementPanelDropdown = BaseStep.findElementXpathWithWait("//span[@class='ant-menu-title-content']/a[@href='/procurement-dashboard']", TimeOut.SHORT.value);
        LogTest.info("Satın Alma butonuna tıklanıyor");
        BaseStep.clickElement(ProcurementPanelDropdown, "Satın Alma butonuna tıklandı");
    }
}
