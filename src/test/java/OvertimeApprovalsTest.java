...
public class OvertimeApprovalsTest extends BaseStep {
    ...
    public void PageOvertimeApprovals() {
        ...
        WebElement OvertimeApprovalsDropdown = BaseStep.findElementXpathWithWait("//span[@class='ant-menu-title-content']/a[@href='/performance/timesheet-approval']", TimeOut.SHORT.value);
