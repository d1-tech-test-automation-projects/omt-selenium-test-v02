...
public class AdminPanelTest extends BaseStep {
    ...
    @Test
    @Order(2)
    @DisplayName("Yönetici Paneli Sayfası Test Ediliyor")
    public void PageAdminPanel() {
        BaseStep.waitSeconds(3);
        LogTest.info("Yönetici Paneli dropdown aranıyor");
        WebElement adminPanelDropdown = BaseStep.findElementXpathWithWait("//span[@class='ant-menu-title-content']/a[@href='/manager-dashboard']", TimeOut.SHORT.value);
        LogTest.info("yönetici paneli butonuna tıklanıyor");
        BaseStep.clickElement(adminPanelDropdown, "yönetici paneline butonuna tıklandı");
    }
}
