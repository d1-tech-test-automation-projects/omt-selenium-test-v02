...
public class ContractManagementTest extends BaseStep {
    ...
    public void PageContractManagement() {
        ...
        WebElement ContractManagementDropdown = BaseStep.findElementXpathWithWait("//span[@class='ant-menu-title-content']/a[@href='/contract-management']", TimeOut.LONG.value);
